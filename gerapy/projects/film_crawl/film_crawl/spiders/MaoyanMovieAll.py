...
class MaoyanmovieallSpider(Spider):
    ...
    def parse_movie(self, response):
        ...
        try:
            ...
            info['id'] = int(str(int(uuid.uuid3(uuid.NAMESPACE_DNS, str(items['nm']) + str(items['rt']))))[0:12])
            ...
            while start_time.split(' ')[0] > end_time:
                ...
                for page in range(67):
                    ...
                    yield Request(comments_url, callback=self.parse_comments,
                                  meta={'source_url': comments_url, 'name': items['nm'], 'pubdate': items['rt']})
    ...
    def parse_comments(self, response):
        ...
        try:
            ...
            pubate = response.meta['pubate']
            for item in items:
                comment['id'] = str(int(uuid.uuid3(uuid.NAMESPACE_DNS, str(name) + str(pubate))))[0:12]
