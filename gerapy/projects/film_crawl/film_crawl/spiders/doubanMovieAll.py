...
class DoubanmovieallSpider(Spider):
    name = 'doubanMovieAll'
    allowed_domains = ['douban.com']

    def __init__(self, *args, **kwargs):
        super(DoubanmovieallSpider, self).__init__(*args, **kwargs)
    ...
    def exc_sql(self):
        ...
        cursor = db.cursor()
        query_sql = "SELECT movie_id FROM {}.douban_movie_request ORDER BY request_date DESC, movie_id".format(database)
