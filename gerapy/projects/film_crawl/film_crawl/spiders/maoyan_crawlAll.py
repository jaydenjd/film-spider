...
class MaoyanCrawlAllSpider(Spider):
    name = 'maoyan_crawlAll'
    allowed_domains = ['maoyan.com']

    def __init__(self, *args, **kwargs):
        super(MaoyanCrawlAllSpider, self).__init__(*args, **kwargs)
    ...
    #     cursor = db.cursor()
    #     query_sql = "SELECT movie_id FROM film_spider.request_info ORDER BY request_date DESC, movie_id"
